...
![The Round screen on the phone: the tabs of the moments of the day, then each resident with the medication, the dose, the route and the Given button](../assets/screenshots/soins-mobile/phone-04-tour.png)
...
![The window of a dose not given: the refusal reasons, the remark field, Record refusal, and the Not available, In hospital and Skipped buttons](../assets/screenshots/soins-mobile/phone-05-tour-non-donnee.png)
