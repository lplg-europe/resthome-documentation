...
ORDER = [
    "index",
    "premiers-pas",
    "residents/index", "residents/gerer-un-resident", "residents/evaluations",
    "residents/changement-chambre", "residents/chambres", "residents/entretien-chambres",
    "residents/etat-des-lieux", "residents/procedure-emmenagement", "residents/mobilier",
    "admissions/index", "admissions/dossier-candidat", "admissions/admettre",
    "facturation/index", "facturation/facturer-un-mois", "facturation/checklist-fin-de-mois",
    "facturation/supplements", "facturation/application-supplements",
    "facturation/absences", "facturation/depart-deces", "facturation/refacturation-fournisseur",
    "facturation-partagee/index", "facturation-partagee/configuration",
    "facturation-partagee/factures",
    "soins/index", "soins/dossier-medical", "soins/anamnese", "soins/prescriptions",
    "soins/plans-de-soins", "soins/registres",
    "soins-mobile/index",
    ...
    # Espace Belgique (ordre de la navigation « Belgium » de content/index.md)
    "belgique/index", "belgique/parcours-facturation", "belgique/dossier-resident",
    "belgique/admission", "belgique/katz", "belgique/facturation", "belgique/forfait-inami",
    "belgique/ehealth/index", "belgique/ehealth/mda", "belgique/ehealth/mda-erreurs",
    "belgique/ehealth/efact", "belgique/ehealth/efact-rejets", "belgique/ehealth/efact-paiements",
    "belgique/ehealth/eagreement", "belgique/ehealth/eagreement-refus",
    "belgique/ehealth/eagreement-signature",
